...
// ─────────────────────────────────────────────
//  CONFIGURACIÓN: interceptores y factory
// ─────────────────────────────────────────────
...
// ─────────────────────────────────────────────
//  3. ASPECTO VALIDACIÓN (simulación BD)
// ─────────────────────────────────────────────
...
// Reproducir 3 películas para acumular puntos (3 × 50 = 150 pts)
foreach (var contenido in contenidoService.ObtenerTodos().Take(3))
{
    contenido.UsuarioActivo = usuario1;  // asignar usuario ANTES de Reproducir()
    contenido.Reproducir();              // el proxy intercepta → ActualizarPuntaje() → evento ContenidoVisto
    Console.WriteLine();
}
...
// usuario1 ya tiene 150 pts. Reproducir suficientes contenidos para llegar a 700.
Console.WriteLine($"Puntos actuales: {usuario1.Puntos}. Reproduciendo contenidos hasta alcanzar categoría Pro...");
Console.WriteLine();
...
// ─────────────────────────────────────────────
//  7. ASPECTO GESTIÓN RÉCORD + EVENTO NUEVO RÉCORD
// ─────────────────────────────────────────────
...
// Establecer récord mediante el proxy (interceptor valida antes)
